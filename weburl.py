...
if len(url) < 1 : url = 'https://pr4e.dr-chuck.com/tsugi/mod/python-data/data/known_by_Dania.html'
if url == 'a' : url = 'https://pr4e.dr-chuck.com/tsugi/mod/python-data/data/known_by_Fikret.html'
#looping to get data
count = 0
lst = list()
while count < counter:
